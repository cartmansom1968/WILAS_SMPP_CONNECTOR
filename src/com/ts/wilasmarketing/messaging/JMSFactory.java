...
//    TextMessage message = session.createTextMessage ("Hello, world!");
    ...
    public ObjectMessage receive(long duration) {
      // Create a simple text message and send it
//    TextMessage message = session.createTextMessage ("Hello, world!");
      ObjectMessage message = null;
      try {
        return (ObjectMessage) consumer.receive(duration);
      } catch (JMSException e) {
        e.printStackTrace();
      }
  ...
  static public class JMSProducer {
    ...
    public void send(Serializable messagingObj) throws BoxException {
      // Create a simple text message and send it
//    TextMessage message = session.createTextMessage ("Hello, world!");
      ObjectMessage message = null;
      try {
        ...
        e.printStackTrace();
        throw new BoxException("Failure", e);
      }
    }
