...
public class BindTransceiver implements DefaultSetting{
  ...
  private byte addrnpi = 0;
	...
	public BindTransceiver(String systemid, String password , String systemtype, byte interfaceversion,
	...
	public byte[] getBytes(int seq){
		...
		try{
			...
			PDUHeader header = new PDUHeader(BIND_TRANSCEIVER, NULL_BYTE, seq);
